    ...
    public class ScheduleData
    {
        ...
        public List<ResourceData> GetResourceData()
        {
            ...
            resourceData.Add(new ResourceData
            {
                Id = 44,
                Subject = "Resource planning",
                StartTime = new DateTime(2018, 4, 22, 13, 0, 0),
                EndTime = new DateTime(2018, 4, 22, 14, 30, 0),
                IsAllDay = false,
                OwnerId = 2
            });
            resourceData.Add(new ResourceData
            {
                Id = 45,
                Subject = "Timeline estimation",
                StartTime = new DateTime(2018, 4, 23, 9, 0, 0),
                EndTime = new DateTime(2018, 4, 23, 10, 0, 0),
                IsAllDay = false,
                OwnerId = 1
            });
            resourceData.Add(new ResourceData
            {
                Id = 46,
                Subject = "Developers Meeting",
                StartTime = new DateTime(2018, 4, 23, 14, 0, 0),
                EndTime = new DateTime(2018, 4, 23, 15, 45, 0),
                IsAllDay = false,
                OwnerId = 2
            });
            resourceData.Add(new ResourceData
            {
                Id = 47,
                Subject = "Project Review",
                StartTime = new DateTime(2018, 4, 24, 11, 0, 0),
                EndTime = new DateTime(2018, 4, 24, 12, 0, 0),
                IsAllDay = false,
                OwnerId = 1
            });
            resourceData.Add(new ResourceData
            {
                Id = 48,
                Subject = "Manual testing",
                StartTime = new DateTime(2018, 4, 24, 9, 0, 0),
                EndTime = new DateTime(2018, 4, 24, 11, 30, 0),
                IsAllDay = false,
                OwnerId = 2
            });
            resourceData.Add(new ResourceData
            {
                Id = 49,
                Subject = "Project Preview",
                StartTime = new DateTime(2018, 4, 25, 9, 30, 0),
                EndTime = new DateTime(2018, 4, 25, 11, 0, 0),
                IsAllDay = false,
                OwnerId = 1
            });
            resourceData.Add(new ResourceData
