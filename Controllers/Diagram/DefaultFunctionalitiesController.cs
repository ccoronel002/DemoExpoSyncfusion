...
namespace EJ2MVCSampleBrowser.Controllers.Diagram
{
    public partial class DiagramController : Controller
    {
        ...
        public ActionResult DefaultFunctionalities()
        {
            ...
            flowShapes.Add(new FlowShapes() { Id = "Terminator", Shape = new { type = "Flow", shape = "Terminator" } });
            flowShapes.Add(new FlowShapes() { Id = "Process", Shape = new { type = "Flow", shape = "Process" } });
            flowShapes.Add(new FlowShapes() { Id = "Decision", Shape = new { type = "Flow", shape = "Decision" } });
            flowShapes.Add(new FlowShapes() { Id = "Document", Shape = new { type = "Flow", shape = "Document" } });
            flowShapes.Add(new FlowShapes() { Id = "PreDefinedProcess", Shape = new { type = "Flow", shape = "PreDefinedProcess" } });
            flowShapes.Add(new FlowShapes() { Id = "PaperTap", Shape = new { type = "Flow", shape = "PaperTap" } });
            flowShapes.Add(new FlowShapes() { Id = "DirectData", Shape = new { type = "Flow", shape = "DirectData" } });
            flowShapes.Add(new FlowShapes() { Id = "SequentialData", Shape = new { type = "Flow", shape = "SequentialData" } });
            flowShapes.Add(new FlowShapes() { Id = "Sort", Shape = new { type = "Flow", shape = "Sort" } });
            flowShapes.Add(new FlowShapes() { Id = "MultiDocument", Shape = new { type = "Flow", shape = "MultiDocument" } });
            flowShapes.Add(new FlowShapes() { Id = "Collate", Shape = new { type = "Flow", shape = "Collate" } });
            flowShapes.Add(new FlowShapes() { Id = "SummingJunction", Shape = new { type = "Flow", shape = "SummingJunction" } });
            flowShapes.Add(new FlowShapes() { Id = "Or", Shape = new { type = "Flow", shape = "Or" } });
            flowShapes.Add(new FlowShapes() { Id = "InternalStorage", Shape = new { type = "Flow", shape = "InternalStorage" } });
            flowShapes.Add(new FlowShapes() { Id = "Extract", Shape = new { type = "Flow", shape = "Extract" } });
            flowShapes.Add(new FlowShapes() { Id = "ManualOperation", Shape = new { type = "Flow", shape = "ManualOperation" } });
            flowShapes.Add(new FlowShapes() { Id = "Merge", Shape = new { type = "Flow", shape = "Merge" } });
            flowShapes.Add(new FlowShapes() { Id = "OffPageReference", Shape = new { type = "Flow", shape = "OffPageReference" } });
            flowShapes.Add(new FlowShapes() { Id = "SequentialAccessStorage", Shape = new { type = "Flow", shape = "SequentialAccessStorage" } });
            flowShapes.Add(new FlowShapes() { Id = "Annotation", Shape = new { type = "Flow", shape = "Annotation" } });
            flowShapes.Add(new FlowShapes() { Id = "Annotation2", Shape = new { type = "Flow", shape = "Annotation2" } });
            flowShapes.Add(new FlowShapes() { Id = "Data", Shape = new { type = "Flow", shape = "Data" } });
            flowShapes.Add(new FlowShapes() { Id = "Card", Shape = new { type = "Flow", shape = "Card" } });
            flowShapes.Add(new FlowShapes() { Id = "Delay", Shape = new { type = "Flow", shape = "Delay" } });
